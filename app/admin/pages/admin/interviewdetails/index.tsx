  ...
  const columns = [
    {
      ...
      Cell: (props) => {
        return (
          <Link
            href={Routes.SingleInterviewdetailAdminPage({
...
const AdminInterviewdetail = ({ user }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  return (
...
AdminInterviewdetail.authenticate = true
