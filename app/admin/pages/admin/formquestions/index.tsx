  ...
  const columns = [
    {
      ...
      Cell: (props) => {
        return (
          <Link
            href={Routes.SingleFormquestionAdminPage({
...
const AdminFormquestion = ({ user }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  return (
...
AdminFormquestion.authenticate = true
