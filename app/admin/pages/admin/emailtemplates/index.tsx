  ...
  const columns = [
    {
      ...
      Cell: (props) => {
        return (
          <Link
            href={Routes.SingleEmailtemplateAdminPage({
...
const AdminEmailtemplate = ({ user }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  return (
...
AdminEmailtemplate.authenticate = true
