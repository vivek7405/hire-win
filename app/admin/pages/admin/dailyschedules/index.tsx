...
const Dailyschedules = () => {
  ...
  const [{ dailyschedules, hasMore, count }] = usePaginatedQuery(getDailyschedules, {
    where: {
      ...query,
    },
  ...
  const columns = [
    {
      ...
      Cell: (props) => {
        return (
          <Link
            href={Routes.SingleDailyscheduleAdminPage({
...
const AdminDailyschedule = ({ user }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  return (
...
AdminDailyschedule.authenticate = true
