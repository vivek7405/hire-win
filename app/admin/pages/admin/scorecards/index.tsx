  ...
  const columns = [
    {
      ...
      Cell: (props) => {
        return (
          <Link
            href={Routes.SingleScorecardAdminPage({
    ...
    {
      Header: "JobWorkflowStages",
      accessor: "jobWorkflowStages",
...
const AdminScorecard = ({ user }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  return (
...
AdminScorecard.authenticate = true
