...
const Questionoptions = () => {
  ...
  const [{ questionoptions, hasMore, count }] = usePaginatedQuery(getQuestionoptions, {
    where: {
      ...query,
    },
  ...
  const columns = [
    {
      ...
      Cell: (props) => {
        return (
          <Link
            href={Routes.SingleQuestionoptionAdminPage({
...
const AdminQuestionoption = ({ user }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  return (
...
AdminQuestionoption.authenticate = true
