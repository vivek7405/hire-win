...
const Scorecardjobworkflowstages = () => {
  ...
  const [{ scorecardjobworkflowstages, hasMore, count }] = usePaginatedQuery(
  ...
  const columns = [
    {
      ...
      Cell: (props) => {
        return (
          <Link
            href={Routes.SingleScorecardjobworkflowstageAdminPage({
...
const AdminScorecardjobworkflowstage = ({
  user,
    ...
    <AuthLayout title={`Admin | 1UpBlitz`} user={user}>
      <AdminLayout>
        <div className="bg-gray-200 w-full p-2 rounded text-gray-500">
          <p>Scorecardjobworkflowstages</p>
        </div>
...
AdminScorecardjobworkflowstage.authenticate = true

export default AdminScorecardjobworkflowstage
