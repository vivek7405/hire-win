  ...
  const columns = [
    {
      ...
      Cell: (props) => {
        return (
          <Link
            href={Routes.SingleCandidatepoolAdminPage({
...
const AdminCandidatepool = ({ user }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  return (
...
AdminCandidatepool.authenticate = true
