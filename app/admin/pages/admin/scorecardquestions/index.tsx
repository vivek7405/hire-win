  ...
  const columns = [
    {
      ...
      Cell: (props) => {
        return (
          <Link
            href={Routes.SingleScorecardquestionAdminPage({
    ...
    {
      Header: "AllowBehaviourEdit",
      accessor: "allowBehaviourEdit",
    ...
    {
      Header: "CardQuestionId",
      accessor: "cardQuestionId",
...
AdminScorecardquestion.authenticate = true

export default AdminScorecardquestion
