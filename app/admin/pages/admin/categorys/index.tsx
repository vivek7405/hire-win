...
const Categorys = () => {
  ...
  const [{ categorys, hasMore, count }] = usePaginatedQuery(getCategorys, {
    where: {
      ...query,
    },
  ...
  const columns = [
    {
      ...
      Cell: (props) => {
        return (
          <Link
            href={Routes.SingleCategoryAdminPage({
...
const AdminCategory = ({ user }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  return (
...
AdminCategory.authenticate = true
