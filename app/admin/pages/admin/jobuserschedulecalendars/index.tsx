...
const Jobuserschedulecalendars = () => {
  ...
  const [{ jobuserschedulecalendars, hasMore, count }] = usePaginatedQuery(
  ...
  const columns = [
    {
      ...
      Cell: (props) => {
        return (
          <Link
            href={Routes.SingleJobuserschedulecalendarAdminPage({
...
const AdminJobuserschedulecalendar = ({
  user,
...
AdminJobuserschedulecalendar.authenticate = true

export default AdminJobuserschedulecalendar
