    ...
    <LandingLayout title="hire-win | Privacy">
      <section className="px-4">
        ...
        <div className="mt-10 text-justify">
          <h1 className="font-bold">Privacy Policy</h1> <p>Updated at 2022-07-27</p>
          <span>
            hire.win ({`"`}we,{`"`} {`"`}our,{`"`} or {`"`}us{`"`}) is committed to protecting your
            privacy. This Privacy Policy explains how your personal information is collected, used,
            and disclosed by
          </span>{" "}
          <p> hire.win.</p> <br />{" "}
          <div>
            This Privacy Policy applies to our website, https://hire.win, and its associated
            subdomains (collectively, our {`"`}Service{`"`}).
          </div>{" "}
          <p>
            <span>
          ...
          <ul>
            ...
            <li>
              <span>
                ...
                <a>hire.win</a> are based, in this case is <a>India</a>.<br />
              </span>
            </li>{" "}
            <li>
              <span>
                <strong>Customer:</strong> refers to the company, organization or person that signs
                up to use the <a>hire.win</a> Service to manage the relationships with your
            ...
            <li>
              <span>
                ...
                <a>hire.win</a> or are under contract to perform a service on behalf of one of the
                parties.
                <br />
              </span>
            </li>{" "}
          ...
          <div>
            <h1 className="font-bold">What Information Do We Collect?</h1>{" "}
            <p>
              <span>
          ...
          <h1 className="font-bold">How Do We Use The Information We Collect?</h1>{" "}
          <p>
            <span>
          ...
          <h1 className="font-bold">When do we use customer information from third parties?</h1>{" "}
          <p>
            <span>
              We receive some information from the third parties when you contact us. For example,
              when you submit your email address to us to show interest in becoming our customer, we
              receive information from a third party that provides automated fraud detection
              services to us. We also occasionally collect information that is made publicly
              available on social media websites. You can control how much of your information
          ...
          <h1 className="font-bold">Do we share the information we collect with third parties?</h1>{" "}
          <p>
            <span>
              ...
              the service in a shared location, and type of device used to visit the service. They
              may aggregate information about our advertising and what you see on the service and
          ...
          <h1 className="font-bold">How Do We Use Your Email Address?</h1>{" "}
          <p>
            <span>
              By submitting your email address on our service, you agree to receive emails from us.
          ...
          <h1 className="font-bold">Could my information be transferred to other countries?</h1>{" "}
          <p>
            <span>
              We are incorporated in India. Information collected via our website, through direct
              interactions with you, or from use of our help services may be transferred from time
              to time to our offices or personnel, or to third parties, located throughout the
          ...
          <h1 className="font-bold">Is the information collected through our service secure?</h1>{" "}
          <p>
            <span>
          ...
          <h1 className="font-bold">Can I update or correct my information?</h1>{" "}
          <p>
            <span>
              The rights you have to request updates or corrections to the information we collect
              depend on your relationship with us. Personnel may update or correct their information
              as detailed in our internal company employment policies. Customers have the right to
              request the restriction of certain uses and disclosures of personally identifiable
              information as follows. You can contact us in order to (1) update or correct your
              personally identifiable information, (2) change your preferences with respect to
              ...
              paragraph), by cancelling your account. Such updates, corrections, changes and
              deletions will have no effect on other information that we maintain, or information
              ...
              may take reasonable steps (such as requesting a unique password) to verify your
              identity before granting you profile access or making corrections. You are responsible
              for maintaining the secrecy of your unique password and account information at all
              times. You should be aware that it is not technologically possible to remove each and
              every record of the information you have provided to us from our system. The need to
              back up our systems to protect information from inadvertent loss means that a copy of
              your information may exist in a non-erasable form that will be difficult or impossible
              for us to locate. Promptly after receiving your request, all personal information
              stored in databases we actively use, and other readily searchable media will be
          ...
          <h1 className="font-bold">Personnel</h1>{" "}
          <p>
            <span>
              If you are one of our workers or applicants, we collect information you voluntarily
              provide to us. We use the information collected for Human Resources purposes in order
              to administer benefits to workers and screen applicants. You may contact us in order
              to (1) update or correct your information, (2) change your preferences with respect to
              communications and other information you receive from us, or (3) receive a record of
              the information we have relating to you. Such updates, corrections, changes and
              deletions will have no effect on other information that we maintain, or information
              that we have provided to third parties in accordance with this Privacy Policy prior to
          ...
          <h1 className="font-bold">Sale of Business</h1>{" "}
          <p>
            <span>
              We reserve the right to transfer information to a third party in the event of a sale,
              merger or other transfer of all or substantially all of the assets of us or any of its
              Corporate Affiliates (as defined herein), or that portion of us or any of its
          ...
          <h1 className="font-bold">Affiliates</h1>{" "}
          <p>
            <span>
              ...
              by or is under common control with us, whether by ownership or otherwise. Any
          ...
          <h1 className="font-bold">How Long Do We Keep Your Information?</h1>{" "}
          <p>
            <span>
              ...
              with our legal or regulatory obligations, {`we'll`} either remove it from our systems
          ...
          <h1 className="font-bold">How Do We Protect Your Information?</h1>{" "}
          <p>
            <span>
              ...
              or warrant the absolute security of any information you transmit to us or guarantee
          ...
          <p>
            <span>
              The laws of India, excluding its conflicts of law rules, shall govern this Agreement
              and your use of our service. Your use of our service may also be subject to other
          ...
          <p>
            <span>
              ...
              other websites not operated or controlled by us. We are not responsible for the
              ...
              including those that have a link on our platform, is subject to that {`website’s`} own
              rules and policies. Such third parties may use their own cookies or other methods to
          ...
          <h1 className="font-bold">{`Kids'`} Privacy</h1>{" "}
          <p>
            <span>
          ...
          <h1 className="font-bold">Tracking Technologies</h1>{" "}
          <li>
          ...
          <p>
            <span>
              ...
              every time you visit our service as we would not be able to remember that you had
          ...
          <p>
            <span>
              uses {`"`}Sessions{`"`} to identify the areas of our website that you have visited. A
          ...
          <h1 className="font-bold">Information about General Data Protection Regulation (GDPR)</h1>{" "}
          <p>
            <span>
          ...
          <h1 className="font-bold">What is GDPR?</h1>{" "}
          <p>
            <span>
          ...
          <h1 className="font-bold">What is personal data?</h1>{" "}
          <p>
            <span>
              ...
              orientation, and ethnicity. The Data Protection Principles include requirements such
              as:
            </span>
          </p>{" "}
          <ul>
          ...
          <h1 className="font-bold">Why is GDPR important?</h1>{" "}
          <p>
            <span>
              ...
              by increasing enforcement and imposing greater fines for breach. Beyond these facts
              {`it's`} simply the right thing to do. At Help Scout we strongly believe that your
              data privacy is very important and we already have solid security and privacy
          ...
          <p>
            <span>
              ...
              GDPR. processes or stores all personal data in fully vetted, DPA compliant vendors. We
              do store all conversation and personal data for up to 6 years unless your account is
              deleted. In which case, we dispose of all data in accordance with our Terms of Service
              ...
              you! {`We've`} been set up as self service from the start and have always given you
          ...
          <h1 className="font-bold">California Residents</h1>{" "}
          <p>
            <span>
          ...
          <ul>
            <li>
              <span>
                ...
                (3) categories of sources from which we collect Personal Information; and (4)
            ...
            <li>
              <span>
                Right to Delete. You may submit a verifiable request to close your account and we
          ...
          <p>
            <span>For more information about these rights, please contact us.</span>
          </p>{" "}
          <p>
            <br />
          </p>{" "}
          <h1 className="font-bold">California Online Privacy Protection Act (CalOPPA)</h1>{" "}
          <p>
            <span>
