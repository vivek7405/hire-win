      ...
      <div>
        ...
        <p>
          <span>
            ...
            <br />
            <br />
            Under no circumstances shall hire.win team be liable for any direct, indirect, special,
            ...
            even if hire.win team or an authorized representative has been advised of the
            ...
            <br />
            <br /> hire.win will not be responsible for any outcome that may occur during the course
        ...
        <p>
          <span>
            ...
            Terms & Conditions, please do not use the Service. In these Terms & Conditions, {`"`}you
            {`"`} refers both to you as an individual and to the entity you represent. If you
            violate any of these Terms & Conditions, we reserve the right to cancel your account or
        ...
        <ul>
          ...
          <li>
            <span>
              <strong>Country:</strong> where hire.win or the owners/founders of hire.win are based,
              in this case is <a>India</a>.<br />
            </span>
          </li>{" "}
          <li>
            <span>
              <strong>Customer:</strong> refers to the company, organization or person that signs up
              to use the hire.win Service to manage the relationships with your consumers or service
              users.
              <br />
            </span>
          </li>{" "}
          <li>
            <span>
              ...
              computer or any other device that can be used to visit hire.win and use the services.
              <br />
            </span>
          </li>{" "}
          <li>
        ...
        <p>
          <span>
            ...
            providing us with your credit card number and associated payment information, you agree
            that we are authorized to verify information immediately, and subsequently invoice your
            account for all fees and charges due and payable to us hereunder and that no additional
            notice or consent is required. You agree to immediately notify us of any change in your
            billing address or the credit card used for payment hereunder. We reserve the right at
            any time to change its prices and billing methods, either immediately upon posting on
            our Site or by e-mail delivery to your organization’s administrator(s). Any attorney
            fees, court costs, or other costs incurred in collection of delinquent undisputed
            amounts shall be the responsibility of and paid for by you. No contract will exist
            between you and us for the Service until we accept your order by a confirmatory e-mail,
            SMS/MMS message, or other appropriate means of communication. You are responsible for
        ...
        <p>
          <span>
            ...
            service, registering an account, or making a purchase, you hereby consent to our Terms &
            Conditions.
          </span>
        </p>{" "}
        <p>
        ...
        <p>
          <span>
            ...
            strongly advise You to review the Terms & Conditions of every site You visit. We have no
            control over and assume no responsibility for the content, Terms & Conditions or
        ...
        <p>
          <span>
            ...
            your account. If we decide to change our Terms & Conditions, we will post those changes
        ...
        <p>
          <span>
            ...
            applicable law, we, on our own behalf and on behalf of our affiliates and our respective
