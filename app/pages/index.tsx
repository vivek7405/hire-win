  ...
  return (
    <>
        ...
        <div id="landingPage" className="gradient leading-relaxed tracking-wide flex flex-col">
          <nav id="header" className="w-full z-30 top-0 text-white py-1 lg:py-6">
            <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-2 lg:py-6">
              ...
              <div className="block lg:hidden">
                <button
                  id="nav-toggle"
                  className="flex items-center px-3 py-2 border rounded text-neutral-700 border-neutral-600 hover:text-neutral-900 hover:border-green-500 appearance-none focus:outline-none"
                >
                  <svg
              ...
              >
                ...
                <li className="mr-3">
                  <a href="#features" className="inline-block cursor-pointer hover:underline font-semibold text-black no-underline hover:text-neutral-800 hover:text-underline py-2 px-4">
                    Features
                  </a>
                </li>
                <li className="mr-3">
                  <a href="#pricing" className="inline-block cursor-pointer hover:underline font-semibold text-black no-underline hover:text-neutral-800 hover:text-underline py-2 px-4">
                    Pricing
                  </a>
                </li> */}
                </ul>
          ...
          <div className="container mx-auto h-screen">
            <div className="text-center px-3 lg:px-0">
              ...
              {/* <p className="leading-normal text-neutral-800 text-base md:text-xl lg:text-2xl mb-8">
                Fully customizable Application Form, Theme, Company Info & Job Description!
              </p> */}
              <p className="leading-normal text-neutral-800 text-base md:text-xl lg:text-3xl mb-8">
            ...
            {/* <div className="flex items-center w-full mx-auto content-end">
              <div className="browser-mockup flex flex-1 m-6 md:px-0 md:m-12 bg-white w-1/2 rounded shadow-xl">
                <iframe
                  src={process.env.NODE_ENV === "production" ? "https://hire.win/basecamp/Software-Engineer" : "http://localhost:3000/basecamp/Software-Engineer"}
                  title="Job Board"
            ...
            <div className="w-full h-4/6 px-5 py-8 lg:px-10 rounded-lg drop-shadow-lg">
              <div className="w-full h-8 space-x-2 px-3 rounded-t-lg bg-neutral-200 flex justify-start items-center">
                ...
                <iframe
                  src={
                    process.env.NODE_ENV === "production"
                      ...
                      : "http://localhost:3000/basecamp/Software-Engineer"
                  }
                  title="Job Board"
              ...
              <div className="lg:mt-6 flex flex-wrap justify-center lg:justify-start">
                <div className="w-5/6 lg:w-1/2 p-6">
                  <h3 className="text-center lg:text-left text-2xl text-neutral-800 font-bold mb-3">
                    Those needing a Careers Page or an individual Job Application Page
                  </h3>
                  <p className="text-justify text-neutral-600 text-lg lg:mb-8">
                    ...
                    automatically. Embed it to your website in minutes or share it to social media!
                    You may embed/share links to individual jobs as well.
                    <br />
                    <br />
                    The Job Application form can be fully Customised for each job that you create so
                    that you ask relevant questions to the applicants.
                  </p>
                </div>
          ...
          <section id="features" className="bg-white border-b py-8">
            <div className="container mx-auto flex flex-wrap pt-4">
              ...
              <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                <div className="flex-1 bg-neutral-100 rounded-t rounded-b-none overflow-hidden shadow">
                  <a className="flex flex-wrap no-underline hover:no-underline">
                    ...
                    <p className="text-neutral-600 text-base px-6 mb-5">
                      Create as many jobs as you want with the Pro plan. The Free plan is limited to
                      1 job. There is no limit on the number of applicants you can receive.
                    </p>
                  </a>
                </div>
                ...
                <div className="flex items-center justify-start">
                  <button
                    className="mx-auto lg:mx-0 hover:underline gradient2 text-white font-extrabold rounded my-6 py-4 px-8 shadow-lg"
                  >
                    Action
                  </button>
                </div>
              ...
              <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                ...
                <div className="flex items-center justify-end">
                  <button className="mx-auto lg:mx-0 hover:underline gradient2 text-white font-extrabold rounded my-6 py-4 px-8 shadow-lg">
                    Action
                  </button>
                </div>
              </div> */}
              ...
              <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                <div className="flex-1 bg-neutral-100 rounded-t rounded-b-none overflow-hidden shadow">
                  <a className="flex flex-wrap no-underline hover:no-underline">
                    ...
                    <p className="text-neutral-600 text-base px-6 mb-5">
                      Automated Job Board that lists your active jobs. Customise the theme based on
          ...
          <section id="pricing" className="bg-neutral-100 py-8">
            <div className="container mx-auto px-2 pt-4 pb-12 text-neutral-800">
              ...
              <div className="w-full text-center pt-2">
                <div className="mt-1">
                  <span className="text-2xl md:text-3xl lg:text-3xl font-bold">
                    No nonsense per user per job pricing
                  </span>
                </div>
                {/* <div className="mt-1">
                  <span className="text-xl md:text-3xl lg:text-3xl font-bold">
                    No paying extra for features like Google Job Posting
                  </span>
                </div> */}
              </div>

              <div className="flex flex-col md:flex-row lg:flex-row justify-center my-12 space-x-8 space-y-8 md:space-y-0 lg:space-y-0">
                {/* <div className="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
                  <div className="flex-1 bg-white text-neutral-600 rounded-t rounded-b-none overflow-hidden shadow">
                  ...
                  <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                    <div className="w-full py-6 text-3xl text-neutral-600 font-bold text-center">
                ...
                <div className="text-black flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-white bg-gradient-to-br md:bg-gradient-to-bl lg:bg-gradient-to-bl from-pink-100 via-violet-100 to-indigo-200 shadow hover:shadow-lg">
                  <div className="flex-1 rounded-t rounded-b-none overflow-hidden">
                    <div className="w-full p-8 text-center">
                      ...
                      <br />
                      <div className="mt-2">
                        <span className="text-lg">1 job with all the essential features</span>
                      </div>
                    </div>
                    <ul className="w-full text-center text-xl font-bold">
                      <li className="py-2">1 Job</li>
                      <li className="py-2">+</li>
                      <li className="py-2">Essential app features</li>
                    </ul>
                  </div>
                ...
                <div className="text-black flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-white bg-gradient-to-br from-red-100 via-purple-100 to-indigo-300 shadow hover:shadow-lg">
                  <div className="flex-1 rounded-t rounded-b-none overflow-hidden">
                    <div className="w-full p-8 text-center">
                      ...
                      <br />
                      <div className="mt-2">
                        <span className="text-lg">Unlimited jobs with all the app features</span>
                      </div>
                    </div>
                    {/* <ul className="w-full text-center text-base font-bold">
                      <li className="py-4">Unlimited Jobs</li>
                      <li className="py-4">Unlimited Applicants</li>
                      <li className="py-4">Job Board with Theme Customization</li>
                      <li className="py-4">Automatic Job Posting to Google Jobs</li>
                      <li className="py-4">Fully Customizable Application Form</li>
                      <li className="py-4">Resume Parser</li>
                      <li className="py-4">Collaborate with unlimited users per job</li>
                      <li className="py-4">Embeddable Job Board Widget</li>
                    </ul> */}
                    <ul className="w-full text-center text-xl font-bold">
                      <li className="py-2">Unlimited Jobs</li>
                      <li className="py-2">+</li>
                      <li className="py-2">All the app features</li>
                    </ul>
                  </div>
                  <div className="flex-none mt-auto rounded-b rounded-t-none overflow-hidden p-6">
                    <div className="w-full py-6 text-4xl font-bold text-center">
                      <span className="text-base">Flat</span> $24.99{" "}
              ...
              <div className="w-full flex flex-row items-center justify-center text-center">
                <div className="w-full md:w-2/3 lg:w-2/3 text-lg md:text-2xl lg:text-3xl font-semibold">
                  Create jobs, invite users/interviewers,
                  <br />
                  {/* &
                  <br /> */}
                  Keep a track of candidates,
                  <br />
            ...
            <div className="container mx-auto mt-8 px-8">
              <div className="w-full flex flex-col md:flex-row py-6">
                ...
                <div className="flex-1">
                  <p className="uppercase font-extrabold text-neutral-500 md:mb-6">Links</p>
                  <ul className="list-reset mb-6">
                    <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                      <a className="cursor-pointer font-light no-underline hover:underline text-neutral-800 hover:text-orange-500">
                        FAQ
                      </a>
                    </li>
                    <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                ...
                <div className="flex-1">
                  <p className="uppercase font-extrabold text-neutral-500 md:mb-6">Legal</p>
                  <ul className="list-reset mb-6">
                    <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                      <a className="cursor-pointer font-light no-underline hover:underline text-neutral-800 hover:text-orange-500">
                        Terms
                ...
                <div className="flex-1">
                  <p className="uppercase font-extrabold text-neutral-500 md:mb-6">Social</p>
                  <ul className="list-reset mb-6">
                    <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                      <a className="cursor-pointer font-light no-underline hover:underline text-neutral-800 hover:text-orange-500">
                        Facebook
                ...
                <div className="flex-1">
                  <p className="uppercase font-extrabold text-neutral-500 md:mb-6">Company</p>
                  <ul className="list-reset mb-6">
                    <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                      <a className="cursor-pointer font-light no-underline hover:underline text-neutral-800 hover:text-orange-500">
                        Official Blog
      ...
      <style jsx>{`
        ...
        .gradient {
          background-image: linear-gradient(-225deg, #fdf2f8 0%, #4f46e5 100%);
        }

        button,
        .gradient2 {
          background-color: #9087de;
          background-image: linear-gradient(315deg, #7c3aed 0%, #d946ef 74%);
        }
