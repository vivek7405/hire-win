          ...
          <nav id="header" className="w-full z-30 top-0 text-white py-1 lg:py-6">
            <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-2 lg:py-6">
              ...
              >
                ...
                <li className="mr-3">
                  <a href="#features" className="inline-block cursor-pointer hover:underline font-semibold text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4">
                    Features
                  </a>
                </li>
                <li className="mr-3">
                  <a href="#pricing" className="inline-block cursor-pointer hover:underline font-semibold text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4">
                    Pricing
                  </a>
                </li> */}
                </ul>
