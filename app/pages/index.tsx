        ...
        <div id="landingPage" className="gradient leading-relaxed tracking-wide flex flex-col">
          ...
          <section id="compareWithOthers" className="bg-neutral-100 border-b py-8">
            <div className="container max-w-5xl mx-auto m-8">
              ...
              <div className="lg:mt-6 flex flex-wrap flex-col-reverse lg:flex-row items-center lg:items-start">
                <div className="w-full lg:w-1/2 p-6">
                  <svg
                    className="w-full h-64 mx-auto"
                ...
                <div className="w-5/6 lg:w-1/2 p-6">
                  <div className="align-middle">
                    ...
                    <p className="text-justify text-neutral-600 text-lg lg:mb-8">
                      ...
                      <br />
                      <br />
                      The Job Application form can be fully Customised for each job that you create
                      so that you ask relevant questions to the applicants.
                    </p>
                  </div>
                </div>
              </div>
