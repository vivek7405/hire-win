...
import generateInviteToJobToken from "src/jobs/mutations/generateInviteToJobToken"
import getTokens from "src/jobs/queries/getTokens"
...
export const getServerSideProps = gSSP(async (context) => {
  ...
  if (user) {
    ...
    return {
      redirect: {
        destination: `/auth/login?next=/jobs/${context?.params?.slug}/settings/keys`,
        permanent: false,
      },
      props: {},
    }
