  ...
  await db.formQuestion.createMany({
    data: [
      ...
      },
      {
        ...
        slug: "location",
        placeholder: "Montgomery, Alabama",
        type: FormQuestionType.Single_line_text,
        acceptedFiles: "",
        createdById: ctx.session.userId || "0",
      },
        ...
        switch (stage?.name) {
          ...
          case "Shortlist":
            return [
              {
                stageId: stage.id,
                title: "Not Overqualified",
                slug: "not-overqualified",
                order: 1,
                createdById: user.id,
              },
              {
                stageId: stage.id,
                title: "Stands Out from Competition",
                slug: "stands-out-from-competition",
                order: 2,
                createdById: user.id,
              },
              {
                stageId: stage.id,
                title: "Balanced Soft & Technical Skills",
                slug: "balanced-soft-and-technical-skills",
                order: 3,
                createdById: user.id,
              },
            ]
