...
CREATE TABLE "LifetimeCoupon" (
    ...
    CONSTRAINT "LifetimeCoupon_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "LifetimeCoupon" ADD CONSTRAINT "LifetimeCoupon_redeemedByUserId_fkey" FOREIGN KEY ("redeemedByUserId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
